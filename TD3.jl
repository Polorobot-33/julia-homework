...
@bind A PlutoUI.Slider(0:0.5:10, show_value=true)

# ╔═╡ f20fccae-5b15-4a11-a9a2-a50d25937f36
@bind B PlutoUI.Slider(-5:0.5:5, show_value=true)

# ╔═╡ 75d4d987-3c1c-4852-86de-a0b6b881dac4
t=[x for x in -5:0.01:5]

# ╔═╡ 6672be72-bf11-455e-a601-e8ebc7027fdb
@bind w PlutoUI.Slider(0:0.1:20, show_value=true)

# ╔═╡ 418cf860-311a-44eb-ae9f-1d3078e3b4d5
func(t) = A * sin(t*w) + B

# ╔═╡ 82483ef0-585b-45c4-9627-688f89761a1e
y = func.(t)

# ╔═╡ bbf5bf23-e7ef-41be-9fed-f25a91608e87
let f = Figure();
	ax = Axis(f[1,1], limits=(-5, 5, -6, 11))
	lines!(ax, t, y)
	
	f
end

# ╔═╡ 37c8c3f8-7e0d-4fb4-9d67-a0c257d9e6f1
func(-3), func(2), func(4)

# ╔═╡ af1bc82b-8a01-4f8f-bac2-a859705f67f3
#Des valeurs de A, B, w permettant de remplir les conditions sont :
#A = 3, B = 2, w = 0.3

# ╔═╡ 5648f0d6-3dbb-4f1c-9366-93261aae526e
md"""
## Exercice 2
"""

# ╔═╡ c02bed5a-a48a-4801-83fb-e1ee16223fb2
struct Pendulum{Tm, Tl0, Tk}
	m::Tm;
	l0::Tl0;
	k::Tk;
end
